...
public class TutBlockTags extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(Registration.GENERATOR_BLOCK.get(), Registration.CHARGER_BLOCK.get());
        tag(BlockTags.NEEDS_IRON_TOOL).add(Registration.GENERATOR_BLOCK.get(), Registration.CHARGER_BLOCK.get());
     }
}
